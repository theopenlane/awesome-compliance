...
- [Unicis Platform](https://github.com/UnicisTech/unicis-platform-ce) - Self-hostable GRC platform for startups & SMEs covering GDPR records of processing, transfer and privacy impact assessments, and security control tracking and mapping, awareness training, risk and asset management (Apache-2.0).
