...
- [CRACI](https://craci.com/build-time-sboms) - Managed GitHub Actions runners that record a CycloneDX or SPDX SBOM for every build and track vulnerabilities in what shipped. Produces audit evidence from CI/CD for frameworks such as the EU Cyber Resilience Act.
