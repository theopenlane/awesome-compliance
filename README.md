...
- [asqav](https://github.com/jagmarques/asqav-sdk) - AI agent governance SDK with quantum-safe (ML-DSA-65) signed audit trails, policy enforcement, and threat detection (MIT). Addresses EU AI Act and NIST AI RMF compliance for autonomous AI systems. ([Docs](https://asqav.com/docs/) | [PyPI](https://pypi.org/project/asqav/))
