...
- [SetAIComply](https://www.setaicomply.com) - EU AI Act compliance workspace built for European SMEs: applicability scoping, Annex III risk classification, Annex IV technical documentation, and DPIAs across all 24 official EU languages. EU-hosted. The public risk-tier checker is free, runs client-side with no signup, and is embeddable on third-party sites. (Freemium)
