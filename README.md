...
- [art50-ci](https://github.com/Rubiss/art50-ci) - Open-source GitHub Action and CLI for regression-testing delivered AI disclosures and configured C2PA provenance, retaining portable JSON, HTML, screenshot, and provenance evidence without determining Article 50 scope or legal compliance. MIT licensed. ([Practical guide](https://art50-ci.rubiss89.chatgpt.site/guides/article-50-ai-disclosure-ci))
